...
sponge_pbottom = surface_pressure/10 # [Pa] Set the lower pressure boundary for the model sponge layer in Pa.
...
exp = Experiment('55cnce_1e4pa_1e-4co2_n2', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'n2_mix_ratio': 0.9998428661219358,  #  mixed gas concentrations (kg / kg)
        'co2_ppmv': 1e2, 
