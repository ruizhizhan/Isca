...
surface_pressure = 1.0e4 # [Pa] reference_sea_level_press
scale_heights = 4.0 # 4.0 -> 0.08ps; 6.0 -> 0.01 ps
# rayleigh drag; test to stablize the simulation
trayfric = -10/86400 # neg. value: time in *days*; larger value -> weaker damping
sponge_pbottom = surface_pressure/2 # [Pa] Set the lower pressure boundary for the model sponge layer in Pa.
...
# spectral files
spec_file = f"b85_55CancriA_SiO_T62xP22_001_nk20" # pure sio
...
exp = Experiment('55cnce_1e4pa_1e0sio', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'cfc113_mix_ratio':0.0,'hcfc22_mix_ratio':1.0,  
    },
...
if __name__=="__main__":
    ...
    exp.run(121, num_cores=NCORES, overwrite_data=False)
    overwrite = False
