...
trayfric = -1/86400 # neg. value: time in *days*; larger value -> weaker damping
...
# spectral files
spec_file = f"b85_55CancriA_CO_T62xP22_001_nk20" # pure co
...
exp = Experiment('55cnce_1e3pa_1e0co', codebase=cb)
exp.clear_rundir()
