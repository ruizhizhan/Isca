...
surface_pressure = 5.0e4 # [Pa] reference_sea_level_press
...
sponge_pbottom = surface_pressure/4 # [Pa] Set the lower pressure boundary for the model sponge layer in Pa.
...
# spectral files
spec_file = f"b85_55CancriA_CO2_T62xP22_001_nk20" # pure co2
...
exp = Experiment('55cnce_5e4pa_1e0co2', codebase=cb)
exp.clear_rundir()
