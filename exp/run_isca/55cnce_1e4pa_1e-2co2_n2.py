...
trayfric = -864/86400 # neg. value: time in *days*; larger value -> weaker damping
sponge_pbottom = surface_pressure/5 # [Pa] Set the lower pressure boundary for the model sponge layer in Pa.
## time and space resolution (from grid/sound_speed 600s)
dt_rad = 5
dt_atmos = 1
RESOLUTION = 'T42', 40
## atmosphere settings
kappa = 0.28490028490028485
mole_mass = 28.16e-3 # kg/mol
rdgas = 8.314/mole_mass
# spectral files
spec_file = f"b85_co2-n2_55CancriA" # co2-co mixed gas
...
exp = Experiment('55cnce_1e4pa_1e-2co2_n2', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'n2_mix_ratio': 0.984375,  #  mixed gas concentrations (kg / kg)
        'co2_ppmv': 1e4, 
