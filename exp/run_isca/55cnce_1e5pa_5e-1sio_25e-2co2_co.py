...
sponge_pbottom = surface_pressure/1e2 # [Pa] Set the lower pressure boundary for the model sponge layer in Pa.
...
exp = Experiment('55cnce_1e5pa_5e-1sio_25e-2co2_co', codebase=cb)
exp.clear_rundir()
