...
# spectral files
spec_file = f"b110_55CancriA_CO2_T62xP22_001_nk20" # pure co2
...
exp = Experiment('55cnce_1e4pa_1e0co2_110', codebase=cb)
exp.clear_rundir()

#Tell model how to write diagnostics
diag = DiagTable()
#diag.add_file('atmos_min', 1, 'minutes', time_units='minutes')
