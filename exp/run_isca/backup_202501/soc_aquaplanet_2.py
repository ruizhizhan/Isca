...
exp = Experiment('soc_aquaplanet_2', codebase=cb)
exp.clear_rundir()
...
diag.add_file('atmos_step', 20, 'seconds', time_units='seconds')
...
if __name__=="__main__":
    ...
    exp.run(481, num_cores=NCORES, overwrite_data=False)
    overwrite = False
    for i in range(482, 485):
