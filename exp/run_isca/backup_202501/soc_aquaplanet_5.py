...
exp = Experiment('soc_aquaplanet_5', codebase=cb)
exp.clear_rundir()
...
diag.add_file('atmos_step', 200, 'seconds', time_units='seconds')
...
if __name__=="__main__":
        exp.run(29, use_restart=True, num_cores=NCORES, overwrite_data=False)
