...
RESOLUTION = 'T42', 40
## atmosphere settings
kappa = 0.24999999999999994
mole_mass = 29.5e-3 # kg/mol
...
exp = Experiment('soc_test_mixedh2o', codebase=cb)
exp.clear_rundir()
...
diag.add_file('atmos_step', 3, 'seconds', time_units='seconds')
...
exp.namelist = namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {
        ...
        'do_simple': True,
        'roughness_mom':1e-03,
        'roughness_heat':1e-03,
        'roughness_moist':1e-03,            
